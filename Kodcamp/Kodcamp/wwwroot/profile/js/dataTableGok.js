                                        ...
                                        return (
                                            ...
                                            (m.diff = function (s, c, u) {
                                                var p,
                                                    ...
                                                    y = M.m(this, g);
                                                return (
                                                    (y = ((p = {}), (p[d] = y / 12), (p[h] = y), (p[l] = y / 3), (p[o] = (b - m) / 6048e5), (p[r] = (b - m) / 864e5), (p[n] = b / e), (p[a] = b / t), (p[i] = b / 1e3), p)[f] || b),
                                                    u ? y : M.a(y)
                                                );
                                            }),
                ...
                function (t, e, s) {
                    ...
                    const d = function (t) {
                        ...
                        c = {
                            ...
                            hiddenHeader: !1,
                            footer: !1,
                            labels: { placeholder: "Ara...", perPage: "{select} ", noRows: "Hiçbir kayıt bulunamadı.", info: "{rows} kayıttan {start} ile {end} arası gösteriliyor." },
