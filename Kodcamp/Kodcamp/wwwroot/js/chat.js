...
$(document).ready(() => {
    const connection = new signalR.HubConnectionBuilder()
        .withUrl("https://kodcamp.com/myhub/").build();
    connection.start();
    ...
    $("#btnSend").click(() => {
        ...
        connection.invoke("SendMessageSeletedClientAsync", message, clientName).catch(error => console.log(error));
    ...
    $("#btnLogin").click(() => {
        ...
        if (nickName != "") {
            connection.invoke("GetNickName", nickName).catch(error => console.log(error)); // Girilen kullanıcı adını alıp, servera gönderiyoruz.
    ...
    connection.on("recieveMessage", (message, nickName) => {  
